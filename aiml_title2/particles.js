// const textList = ["ARTIFICIAL INTELLIGENCE","INTELLIGENCE","Enabling machines to learn"];
// const textList = ["ARTIFICIAL INTELLIGENCE","Enabling machines to learn"];
const textList = ["ARTIFICIAL"];
const text1 = "ARTIFICIAL";
const text2 = "INTELLIGENCE";
const text3 = "Enabling machines to learn";
var textPos = 0;
function createParticles(text){
    createTextMap(
        text,  // text to display
        100,    // font size
        "TitilliumWeb-Light",  // font
...
function createTextMap(text,size,font,style,fit){
    ...
    // get size of text
    var width = Math.ceil(tCan.ctx.measureText(text3).width + size);
    ...
    if(style.fillStyle){
        c.font = size*2.45 + "px " + font;
        c.fillText(text1, width /2, tCan.height/ 4.8);
        c.font = size*1.85 + "px " + font;
        c.fillText(text2, width /2, tCan.height/ 1.8);
        c.font = size + "px " + font;
        c.fillText(text3, width / 2, tCan.height/ 1.2);
    }
    // prep the particles
    particles.empty();
    // get the pixel data
...
const particles = {
    ...
    moveIn(){this.direction = .5; return this},
